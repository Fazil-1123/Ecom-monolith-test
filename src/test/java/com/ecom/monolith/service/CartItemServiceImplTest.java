...
public class CartItemServiceImplTest {
    ...
    void getCartItems_Success(){
        ...
        assertThat(responses.getFirst().getProductId()).isEqualTo("1");
        assertThat(responses.getFirst().getQuantity()).isEqualTo(5);
        assertThat(responses.getFirst().getPrice()).isEqualByComparingTo("6500");
